...
export default function LogisterChurch(props:any) {
        ...
        <div className="container">
          ...
          <div className="inputbox">
            ...
            <div className="checkInputCover">
              <div className='checkInput'>
                <input className="input" type="checkbox"
                    checked={logisterDetail === 'e-출석부'}
                    onChange={()=>{setLogisterDetail('e-출석부')}}
                  />
                  <h5>e-출석부</h5>
                </div>
                <div className='checkInput' style={{marginLeft:'10px'}}>
                  <input className="input" type="checkbox"
                    checked={logisterDetail === 'e-전단지'}
                    onChange={()=>{setLogisterDetail('e-전단지')}}
                  />
                <h5>e-전단지</h5>
              </div>
            </div>
